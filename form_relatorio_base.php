...
<table align=center>
<tr><td colspan=4 align=center><h3>Relat&oacuterio de acesso dos artigos</h3></td></tr>
<form method="GET" name="form1" action="relatorio_artigos_base.php" onLoad="focus_campo(this)" onSubmit= "return(ValidaData(form1.data_inicial,form1.data_final))">
