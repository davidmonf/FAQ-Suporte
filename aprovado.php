...
//}
$mail->Body = '<p>Ol&aacute;!<br /><br />Foi criado um novo artigo na Base de Conhecimento:<br /><br /><h3>'.$titulo.'</h3></p><p>Link: <a href = "http://sistemaru.cieesp.org.br:8080/texto_suporte.php?id='.$busca.'">http://sistemaru.cieesp.org.br:8080/texto_suporte.php?id='.$busca.'</a></p><p>Atenciosamente,</p><p>Administrador da Central de Ajuda - Suporte</p>';
...
echo "<script>alert('Artigo aprovado!');window.location = 'texto_suporte.php?id=".$busca."'</script>";
} else {
