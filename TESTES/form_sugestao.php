...
<tr><td>Seu E-mail:</td><td><input type="text" name="email" style="width:150px" value='' /><select name="dominio"><option value="@cieesp.org.br">@cieesp.org.br</option><option value="@cieerj.org.br">@cieerj.org.br</option></select></td></tr>
<?php
if (isset($_GET['id'])){
echo '<tr><td>Erro:</td><td><textarea name="sugestao" style="height: 150px; width: 500px"  rows="4" cols="50"></textarea></td></tr>';
