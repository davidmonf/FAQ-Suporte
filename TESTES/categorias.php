<?php
			 ...
			 $result = mysql_query($sql_categorias, $conecta_banco) or print(mysql_error());  
				...
				echo '<a href="'.$link.'" title="'.$desc_categ.'"><img src="'.$icone.'" width="45" border="0" style="float: middle;"></a>';
				echo '<span style="vertical-align: 20px;"><a href="'.$link.'" title="'.$desc_categ.'"class="lnk_menu">'.$categoria.'</a></span>';
				echo "</td>";
	}
				echo "</tr>";
			echo "</table>";
